...
(function($opal) {
  ...
  return (function($base) {
    ...
    def.$group_by = TMP_13 = function() {
      var $a, $b, TMP_14, $c, self = this, $iter = TMP_13._p, block = $iter || nil, hash = nil;
      TMP_13._p = null;
      if (block === nil) {
...
//@ sourceMappingURL=/__opal_source_maps__/method.js.map
;
/* Generated by Opal 0.5.0 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
...
(function($opal) {
  ...
  return (function($base, $super) {
    ...
    def.$initialize = function(args) {
      var $a, $b, TMP_7, $c, TMP_8, self = this, object = nil;
      args = $slice.call(arguments, 0);
    ...
    def.$each_pair = TMP_11 = function() {
      var $a, $b, TMP_12, self = this, $iter = TMP_11._p, $yield = $iter || nil;
      TMP_11._p = null;
      if ($yield === nil) {
    ...
    return (def.$inspect = function() {
      var $a, $b, TMP_16, self = this, result = nil;
      result = "#<struct ";
    ...
    (function($base) {
      ...
      (function($base) {
        ...
        def.$alias_native = function(new$, old, options) {
          var $a, $b, TMP_1, $c, TMP_2, $d, TMP_3, self = this, as = nil;
          if (old == null) {
            old = new$
          }
          if (options == null) {
